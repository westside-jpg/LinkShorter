...
| Сброс пароля | Автовставка шестизначного кода, отправка формы по Enter, анимации между этапами и конфетти на финальном шаге |
...
После запуска Docker PostgreSQL доступен на localhost:5432
